        ...
        <div class="page-main">
          ...
          <div class="page-header">
            ...
            <div class="page-intro">
              <p>{{ $t('tools.douyinDownloader.intro') }}</p>
              <ul class="features-list">
                <li>{{ $t('tools.douyinDownloader.features.noWaterMark') }}</li>
                <li>{{ $t('tools.douyinDownloader.features.highQuality') }}</li>
                <li>{{ $t('tools.douyinDownloader.features.fastDownload') }}</li>
              </ul>
            </div>
          </div>
...
useSeoMeta({
  ...
  ogImage: '/images/douyin-downloader-og.jpg', // Placeholder - should be replaced with actual image
  ...
  twitterImage: '/images/douyin-downloader-twitter.jpg', // Placeholder - should be replaced with actual image
